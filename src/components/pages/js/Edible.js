...
import style from '../css/Edible.module.css';
...
function Edible() {
    ...
    return (
        <section className={style.edible_container}>
            <div className={style.title}>
                <h1>These are believed to be Edible mushrooms!</h1>
                <p>Be cautious whenever foraging, we don't encourage you to eat any mushrooms without proper knowledge, we post for educational purpouses only!</p>
            </div>
